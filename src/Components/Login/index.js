        ...
        <div className="container ">
          <div className=" d-flex justify-content-center align-items-center flex-lg-row">
            <div
              ...
              className="border border-dark rounded  col-md-8 col-lg-5 bg-l p-5 "
            >
              <h5 className="mb-3 fs-1" id="head">
                {" "}
                Login{" "}
              </h5>
              ...
              {error && (
                <h6 className="m-3 text-danger text-break"> {error} </h6>
              )}
              {success && (
          ...
          <div className="mt-3">
            <button
              className="btn btn-info btn-sm fs-5 mx-3 px-4 text-white mt-3"
            ...
            <span className="mt-3">
              <button
                className="btn btn-dark fs-5 mx-3 text-white mt-3 "
